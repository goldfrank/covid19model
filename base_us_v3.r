...
source('utils/read-data_us3.r')
source('utils/process-covariates_us3.r')
...
countries <- read.csv('data/regions_us3.csv', stringsAsFactors = FALSE)
...
plot_3_panel_error <- system(paste0("Rscript plot-3-panel_us3.r ", filename,'-stanfit.Rdata'),intern=FALSE)
